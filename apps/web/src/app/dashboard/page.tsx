    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid md:grid-cols-5 gap-6 mb-8">
          ...
          <Link
            href="/astrology"
            className="bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow border border-gray-200 text-left block"
          >
            <Star className="h-8 w-8 text-indigo-600 mb-3" />
            <h3 className="font-semibold text-gray-900 mb-1">Natal Chart</h3>
            <p className="text-sm text-gray-600">View your astrological profile</p>
          </Link>
